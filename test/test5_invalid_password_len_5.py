...
class TestInvalidPass:
    def test_invalid_pass(self):
        ...
        d.find_element(*SIGNUP.filed_password2).send_keys('1'*5)
        d.find_element(*SIGNUP.button_signup).click()
        WebDriverWait(d, 5).until(expected_conditions.visibility_of_element_located(ENTRANCE.invalid_password))
