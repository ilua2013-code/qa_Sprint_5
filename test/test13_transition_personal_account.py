...
class TestTransionPersonAcc:
    def test_transit_person_acc(self):
        d = driver()
        ...
        WebDriverWait(d, 10).until(expected_conditions.visibility_of_element_located(BUTTON.exit_from_account))
        assert d.current_url == URL.current_url_personal_account
        d.quit()